    ...
    <div style={{ minHeight: '100vh', background: '#0F172A', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Geist, sans-serif' }}>
      <div style={{ width: '100%', maxWidth: '380px', padding: '0 24px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: '20px', fontWeight: '700', color: '#ffffff', marginBottom: '4px' }}>RIVA Control</h1>
        ...
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '24px' }}>
          {error && (
            <div style={{ background: 'rgba(220,38,38,0.1)', border: '1px solid rgba(220,38,38,0.2)', borderRadius: '7px', padding: '10px 14px', marginBottom: '16px', color: '#FCA5A5', fontSize: '13px' }}>
              {error}
            </div>
          )}
          <div style={{ marginBottom: '14px' }}>
            ...
            <input
              ...
              type="email"
              placeholder="control@getriva.in"
              style={{ width: '100%', padding: '10px 12px', border: '1px solid #E2E8F0', borderRadius: '7px', fontSize: '13px', color: '#0F172A', outline: 'none', background: '#F8FAFC', boxSizing: 'border-box', fontFamily: 'Geist, sans-serif' }}
            />
          </div>
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            style={{ width: '100%', padding: '11px', background: loading ? '#334155' : '#1A56DB', color: 'white', border: 'none', borderRadius: '7px', fontSize: '13px', fontWeight: '600', cursor: 'pointer', fontFamily: 'Geist, sans-serif' }}
          >
